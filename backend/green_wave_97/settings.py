"""
Django settings for green_wave_97 project.
...
ROOT_URLCONF = 'green_wave_97.urls'
...
WSGI_APPLICATION = 'green_wave_97.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_wave_97 API",
    "DESCRIPTION": "API documentation for green_wave_97 App",
    "VERSION": "v1",
}
